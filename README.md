...
Me interesa aplicar buenas prácticas de desarrollo, especialmente la documentación clara y ordenada del código, ya que considero que un proyecto bien documentado no solo facilita el mantenimiento, sino también el aprendizaje propio y el trabajo en equipo.

Aprendo con facilidad, disfruto explorar nuevas herramientas y entender el porqué de las soluciones, no solo el cómo. En este perfil comparto proyectos, ejercicios y prácticas que reflejan mi crecimiento como desarrollador y mi compromiso con mejorar cada día en el mundo del software.
